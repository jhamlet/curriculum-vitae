...
## Part 2: AI & Agentic Coding as Amplifier

### 2.1 How are you currently using AI in your workflow?
...
## Part 3: Work Preferences

### 3.1 Engagement model preferences

> _Rank these 1-5 (1 = most preferred):_

- [1] Long-term contract (3-6 months embedded)
- [2] Project-based engagements (defined scope, defined end)
- [3] Retainer/advisory (ongoing, part-time)
- [4] Full-time employment (would consider for right opportunity)
- [5] Fractional/part-time roles

### 3.2 Team dynamics

> _What role do you want on a team?_

- [x] Solo operator (given a problem, return a solution)
- [ ] Technical lead (guide others, make architectural decisions)
...
> _Rank these 1-4 (1 = most preferred):_

- [1] Early startup (< 20 people, scrappy, undefined)
- [2] Growth startup (20-200, scaling, some process)
- [3] Established company (200+, defined roles)
- [4] Enterprise (1000+, complex org)
...
## Part 4: What You're Moving Away From

### 4.1 What work do you NOT want to do anymore?
...
## Part 5: What You're Moving Toward
...
## Part 6: Value Proposition Testing

### 6.1 Rate these potential positioning statements (1-5, 5 = resonates strongly):

| Statement                                                                                     | Rating | Notes |
| --------------------------------------------------------------------------------------------- | ------ | ----- |
| "I turn ambiguous problems into working solutions, faster with AI"                            | 2      |       |
| "I help teams adopt AI-augmented development practices"                                       | 4      |       |
| "I build the tools and systems that make other developers more productive"                    | 4      |       |
| "I'm a technical problem solver who happens to know a lot about UI"                           | 4      |       |
| "I help companies ship faster by combining deep experience with modern AI tooling"            | **5**  |       |
| "I take on the complex, cross-cutting problems that don't fit neatly into one team's backlog" | **5**  |       |

### 6.2 Write your own positioning statement
...
### 7.1 Rate requirements

> _What's your minimum acceptable rate for contract work?_

**Your answer:** $175-200/hr minimum

### 7.2 Availability

> _How many hours/week are you available? Any constraints?_

**Your answer:** Flexible - varies depending on the engagement

### 7.3 Timeline

> _When do you want/need to start the next engagement?_

**Your answer:** Q1 2026

### 7.4 Geographic/timezone constraints
...
## Part 8: Evidence & Proof Points

### 8.1 What recent work demonstrates your AI-augmented capabilities?
...
2. Run the market research prompt which will use these answers to:
   - Research market demand for your desired positioning
   - Identify companies/roles that match your pivot
   - Provide guidance on resume/positioning language
   - Suggest gaps to address in your narrative
